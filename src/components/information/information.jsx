			...
			<div className='informationInner'>
				...
				>
					<div className='informationHead'>
						<h3 className='informationHead__title'>MRIYA MOTORS MOTORS Wien</h3>
						<div className='informationHead__inner'>
							...
							<p className='informationHead__text'>Wien, Österreich</p>
						</div>
					</div>
					<div className='informationBody'>
						<div className='informationBody__inner'>
							<p className='informationBody__text'>Phone:</p>
